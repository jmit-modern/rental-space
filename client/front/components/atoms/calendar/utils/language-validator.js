const isArray = (v) =>
  v !== null && Object.prototype.toString.call(v) === '[object Array]'
const isObject = (v) =>
...
const validateScheme = (object, schema) =>
  Object.keys(schema)
    .map((prop) => [prop, schema[prop](object[prop])])
    .reduce((errors, pair) => {
...
export default (langObjects) => {
  ...
  return Object.keys(langObjects)
    .map((key) => [key, validateScheme(langObjects[key], languageSchema)])
    .reduce((valid, pair) => {
