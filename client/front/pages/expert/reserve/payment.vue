          ...
          <div class="lg:w-1/2 mb-8 lg:mx-auto">
            <dl class="px-2 py-4 flex border-b">
              ...
              <dd class="w-3/5 text-right">
                {{ $t('expert.reserveStep.expertFee') }}
              </dd>
    ...
    return {
      ...
      steps: [
        ...
        },
        {
          ...
          route: this.localeRoute({ name: 'expert-reserve-confirm' }),
          status: 'complete',
        },
        {
          id: '03',
    ...
    async handlePay() {
      try {
        ...
        if (cardSetupResult.error) {
          ...
          this.$store.commit('localStorage/clearExpertReservation')
          this.$router.push(
            this.localeRoute({ name: 'expert-reserve-complete' })
          )
        }
      } catch (e) {
        console.error(e)
