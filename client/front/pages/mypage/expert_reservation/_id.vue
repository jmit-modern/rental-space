      ...
      <div class="px-4 py-5">
        ...
        <div class="mb-8">
          ...
          <dl class="px-2 py-4 flex border-b">
            <dt class="w-1/5 font-bold">Payment status:</dt>
            <dd class="w-3/5"></dd>
        ...
        <div v-if="reservation.status == 'reserved'" class="mb-8">
          ...
          <div>
            ...
            <dl class="px-2 py-4 flex border-b">
              ...
              <dd class="w-3/5">{{ expertUser.email }}</dd>
              <dd class="w-1/5 text-right"></dd>
            </dl>
            <dl class="px-2 py-4 flex border-b">
              <dt class="w-1/5">Phone number</dt>
              <dd class="w-3/5">{{ expertUser.phone }}</dd>
              <dd class="w-1/5 text-right"></dd>
            </dl>
          </div>
        </div>
    ...
    breadcrumbs() {
      const items = [
        ...
        },
        {
          id: 3,
          name: '予約エキスパート',
          url: this.localeRoute({ name: 'mypage-expert_reservation' }),
        },
        {
          id: 4,
          name: '予約詳細',
