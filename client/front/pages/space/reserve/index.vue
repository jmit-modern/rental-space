            ...
            <tbody>
              <tr class="border-b">
                <th class="w-1/4 px-12 py-6 text-left">
                  {{ $t('space.reserveStep.numberOfPeople') }}
                  <span class="text-tertiary text-xs">{{
                    $t('space.reserveStep.required')
                  }}</span>
                </th>
              ...
              <tr>
                <th class="w-1/4 px-12 py-6 text-left">
                  {{ $t('space.reserveStep.description') }}
                  <span class="text-tertiary text-xs">{{
                    $t('space.reserveStep.required')
                  }}</span>
                </th>
...
export default {
  ...
  fetch() {
    ...
    this.$store.commit('localStorage/setReservation', { userId: user.id })
  ...
  methods: {
    handleNext() {
      this.$store.commit('localStorage/setReservation', this.inputs)
      this.$router.push(this.localeRoute({ name: 'space-reserve-confirm' }))
    },
  },
}
</script>
